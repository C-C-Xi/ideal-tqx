export const ExceptionEnum ={
    ...
    LOGIN_ERROR_DEVICEINFO:{status:310008, message: "设备号不存在"},
    ...
    ORDER_CLOSED:{status:340904, message: "订单已关闭"},
    ...
    ORDER_ERROR_GOOGLE_CANCELED:{status:340914, message: "google订单已取消"},
